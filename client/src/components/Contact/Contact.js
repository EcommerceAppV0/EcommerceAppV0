            ...
            <div className='child-conatct'>
                ...
                <div className='contact2'>
                    <div className='contact2-child'>
                        ...
                        <div className='box'>
                            <input type="text" placeholder="Write Us what you want " />
                        </div>
                        <div className='sendbtn'>
                            <button className='sendMessage'>Send Massage</button>
                        </div>
                    </div>
                </div>
            </div>
