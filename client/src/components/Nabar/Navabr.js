        ...
        <>
            <div className='navbar-container'>
                ...
                <div className='tabs'>
                    ...
                    >About</div>
                    <div className='link'
                        onClick={() => !loggedIn ? navigate("/signup") : toast.info(`You are signed in Logout First`, {
                            position: "top-center",
                            autoClose: 5000,
                ...
                <div className='frame'>
                    ...
                    <div className='icon'>
                        ...
                        {loggedIn && <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" viewBox="0 0 32 32" fill="none">
